        ...
        if self.is_running == True :
           ...
           #self.axes.title("Current vs Time")
            ...
            if len(self.schedule.queue) == 1 : 
                self.cycles += 1
                self.schedule.enter(50*self.cycles,1,self.mytest.open,[5.0])
                self.schedule.enter(50*self.cycles + 5,1,self.mytest.close,[20.0])
                self.schedule.enter(50*self.cycles + 5 + 20,1,self.mytest.close,[20.0])
